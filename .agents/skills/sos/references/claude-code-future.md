# Claude Code Future Aperture

Claude Code integration is not implemented in this phase.

Keep this reference as a future-only aperture for later design work. Do not write Claude Code settings. Do not create Claude Code commands. Do not claim Claude Code support is complete.
Do not add a Claude Code installer.
