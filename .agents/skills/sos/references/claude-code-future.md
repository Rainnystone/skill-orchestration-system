...
Keep this reference as a future-only aperture for later design work. Do not add Claude Code settings, commands, or installer support. Do not claim Claude Code support is complete.
